...
public class optiimng {
    ...
    public void screenshot(String deviceUDID) throws IOException {
        File srcFile = androidDriver.getScreenshotAs(OutputType.FILE);
        //String filename = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS").format(Calendar.getInstance().getTime());
        File targetFile = new File("/Users/huseyintumer/Desktop/screens/" + deviceUDID + ".jpg");
